...
fn crate_limits(limits: &DecodeLimits) -> Limits {
...
fn orientation_from_crate(orientation: CrateOrientation) -> Orientation {
    match orientation {
...
fn summary_from_raw(raw: Option<Vec<u8>>) -> Option<super::types::ExifSummary> {
